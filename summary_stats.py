...
Compute percent change in population mean size and stability (stdev / mean) between the historical (1950-1999) and future (2050-2099) periods under under projected temperature changes ("usual"), when controlling for trends in mean temperature ("rm_mean_trend"), when controlling for trends in temperature variability ("rm_sd_trend"), and when controlling for trends in both mean temperature and temperature variability ("rm_mean_sd_trend")
